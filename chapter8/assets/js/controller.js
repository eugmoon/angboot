angular.module('contactsMgr', ['ngRoute', 'ngSanitize', 'ngResource'])
...
.factory('contacts', function($resource) {
    var resource = $resource('http://localhost:8888/contacts/:id', {id: '@id'}, {
        update: {method: 'PUT'}
    });
    return {
        get: function() {
...
.controller('indexCtrl', function($scope, contacts, $http) {
